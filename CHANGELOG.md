...
- Create Angular project with ng: `ng new easyclinic.client --defaults --skip-install --skip-git `.
...
- Create project file (`easyclinic.client.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `easyclinic.client.esproj`).
